...
`github.com` entry, sorts and de-duplicates the remaining aliases
deterministically, and retains the prior
...
- Displayed port or port list always means local host port(s), including ephemeral client ports.
